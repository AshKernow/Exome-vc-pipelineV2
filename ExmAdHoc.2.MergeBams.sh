...
#it can be pipelined directly to the GATK local indel realignment stage of the pipeline
...
#	Metrix - M -(flag) - will call the Bam metrics script once the bams are merged but not the full exome analysis pipeline
