...
StepCmd="qsub -o stdostde/ -e stdostde/ -cwd -S /bin/bash -N Relat2 -l mem=8G,time=6:: $TmpRelatScript"
funcRunStep
...
StepCmd="qsub -o stdostde/ -e stdostde/ -cwd -S /bin/bash -N Missing -l mem=8G,time=1:: $TmpMissingScript"
funcRunStep
